...
describe('Exercise 10: Complete the function', () => {
    beforeEach(() => {
    ...
    test(`Evaluate fstring("John", 30, "London") should return "My name is John and have 30 old. I'm from London"`, () => {
        let jsCode = textVariable.replace(/[\n\t\r]+\s*/g, '');
        try {
            ...
            expect(consoleOutput).toContain(`My name is John and have 30 old. I'm from London`);
        } catch (error) {
            console.error("Error during code evaluation:", error);
            throw error;
        }
