...
describe('Exercise 03: Mathematical Operations', () => {
    beforeEach(() => {
    ...
    test('Evaluate a console.log(easyCalculation)', () => {        
        ...
        try {
            ...
            expect(consoleOutput.toBe(453 * 32)).toBe(true);
        } catch (error) {
            console.error("Error during code evaluation:", error);
            throw error;
        }
    ...
    test('Contains specific variable easyCalculation', () => {
        expect(textVariable).toContain("easyCalculation");
    });
