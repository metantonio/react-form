...
describe('Exercise 13: Switch', () => {
    ...
    test('Evaluate pointSystems(0) should return "black"', () => {
        let jsCode = textVariable.replace(/[\n\t\r]+\s*/g, '');
        let newNumber = 0;
        ...
        try {
            ...
            expect(consoleOutput).toContain(`black`);
        } catch (error) {
            console.error("Error during code evaluation:", error);
            throw error;
        }
    ...
    test('Evaluate pointSystems(1) should return "yellow"', () => {
        let jsCode = textVariable.replace(/[\n\t\r]+\s*/g, '');
        let newNumber = 1;
        jsCode = jsCode.replace(
            /console\.log\(speedometer\(\d+\)\);/g,
    ...
    test('Evaluate pointSystems(2) should return "orange"', () => {
        ...
        try {
            ...
            // Verificar la presencia de console.log en la salida
            expect(consoleOutput).toContain(`orange`);
        } catch (error) {
            console.error("Error during code evaluation:", error);
            throw error;
        }
    ...
    test('Evaluate pointSystems(5) should return "blue"', () => {
        ...
        try {
            ...
            // Verificar la presencia de console.log en la salida
            expect(consoleOutput).toContain(`blue`);
        } catch (error) {
            console.error("Error during code evaluation:", error);
            throw error;
        }
